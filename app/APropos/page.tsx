...
export default function Page() {
  return (
      <div className="bg-gray-100 mt-20 ">
                  ...
                  <div className=" relative ">
                      <div className="lg:max-w-xl lg:pr-5 relative ">
                          ...
                          <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                              Batir un projet
                              <span
                                  className="my-1 inline-block border-b-8 border-g4 bg-white px-4 font-bold text-g4 animate__animated animate__flash">SOLIDE</span>
                          </h2>
                          <p className="text-base text-gray-700">Plus de 20 ans d'experiences dans la vente de matériaux de toitures et de bardages</p>
                          <div className="mt-10 flex flex-col items-center md:flex-row">
                              <a href="/#Contact"
                                 className="mb-3 inline-flex h-12 w-full items-center justify-center rounded btn text-white bg-blue-600 hover:bg-blue-700 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                                  Nous contacter</a>
                              <a href="/" aria-label=""
                                 className="group inline-flex items-center font-semibold text-g1">Découvrez nos produits
          ...
          {/*<div className=" relative -bottom-24 left-10 opacity-10 ">
              <svg width="800px" height="800px" viewBox="0 0 24 24"
                   className="w-96   h-full    object-fill fill-gray-300 text-gray-300" fill="none"
          ...
          <div className=" relative -bottom-0 left-3/4  opacity-10 ">
          ...
          <div className=" relative top-10 left-3/4 opacity-10 ">
